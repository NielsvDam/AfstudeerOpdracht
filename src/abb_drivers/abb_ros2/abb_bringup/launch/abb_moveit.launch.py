...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "robot_xacro_file",
            default_value="abb_irb120.urdf.xacro",
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "support_package",
            default_value="abb_irb120_support",
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            ...
            description="Name of the moveit_config package"
        )
    )
    declared_arguments.append(
        DeclareLaunchArgument(
            "moveit_config_file",
            default_value="abb_irb120.srdf", # .srdf, change to srdf.xacro if needed.
