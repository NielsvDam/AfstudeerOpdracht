...
def generate_launch_description():  
    ...
    rviz_config_file = os.path.join(
        ...
        'rviz',
        'rv5as_camera.rviz' #<<! Change to irb120 rviz package once made. >>
    )
    # moveit configuration for rviz node (robot model, kinematics, etc.)
    moveit_config = MoveItConfigsBuilder("irb120", package_name="abb_irb120_moveit_config").to_moveit_configs() # Was "rv5as" and "melfa_rv5as_moveit_config".
